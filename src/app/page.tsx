...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-x-hidden w-full">
      <main className="container mx-auto px-4 py-12 max-w-full overflow-x-hidden">
        {/* Hero Section */}
        ...
        {/* Results Header */}
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0 gap-4">
          ...
          {Object.values(selectedFilters).some(filter => filter) && (
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-lg transition-all duration-200 whitespace-nowrap flex-shrink-0"
            >
      ...
      {/* Enhanced Footer */}
      <footer className="bg-white border-t border-gray-200 py-12 mt-20 w-full overflow-x-hidden">
